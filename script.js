...
function handleShare() {
    ...
    if (window.va) {
        window.va('track', 'Share Button Clicked');
    }
...
async function copyImageToClipboard() {
    try {
        ...
        if (window.va) {
            window.va('track', 'Image Copied to Clipboard');
        }
...
function toggleCategoryChip(category) {
    ...
    if (chip.classList.contains('selected')) {
        ...
        // Track category deselection event
        if (window.va) {
            window.va('track', 'Category Deselected', { category: category });
        }
    } else {
        ...
        if (window.va) {
            window.va('track', 'Category Selected', { category: category });
        }
    }
...
function filterByCategory(category) {
    ...
    // Track single category filter event
    if (window.va) {
        window.va('track', 'Category Filter Applied', { category: category });
    }
...
document.addEventListener('DOMContentLoaded', function() {
    // Track page view
    if (window.va) {
        window.va('track', 'Page View', { page: 'HyperEVM Ecosystem Graph' });
    }
...
function filterGraphByCategories(selectedCategories) {
    if (!selectedCategories || selectedCategories.length === 0) {
        ...
        if (window.va) {
            window.va('track', 'Category Filters Cleared');
        }
